...
import { containerVariants } from "@/public/utils/constants";
...
export default function HeroSection() {
  return (
    <MotionSection variants={containerVariants} initial="hidden" animate="visible" className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      ...
      {/* Badge */}
      <MotionDiv variants={heroItemVariants} className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group">
        <Badge
          variant={"secondary"}
      ...
      {/* Title */}
      <MotionH1 variants={heroItemVariants} className="font-bold py-6 text-center">
        Transform PDFs into{" "}
      ...
      {/* Description */}
      <MotionH2 variants={heroItemVariants} className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">
        Get a beautiful summary reel of the document in seconds.
      </MotionH2>

      {/* Button */}
      <MotionDiv variants={heroItemVariants} whileHover={buttonVariants}>
        <Button
          variant={"link"}
